export default {
  loading: "~/components/MainLoading.vue",
  router: {
    extendRoutes(routes) {
      routes.push({
        path: "/",
  ...
  ** Global CSS
  */
  css: ["~/assets/css/style.css","~/assets/scss/app.scss", 'quill/dist/quill.core.css', 'quill/dist/quill.snow.css', 'quill/dist/quill.bubble.css'],
  /*
