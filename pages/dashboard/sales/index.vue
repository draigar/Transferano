...
import SellOrder from "@/components/pages/dashboard/orders/sell-order";
import BuyOrder from "@/components/pages/dashboard/orders/buy-order";
export default {
  head() {
    return {
      title: `Transferano : Dashboard`,
    };
  },
  components: {
    WidgetChart,
