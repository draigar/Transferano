...
<div class="left-side-menu">
    ...
    <div class="logo-box">
        <nuxt-link to="/" class="logo logo-dark text-center">
            <span class="logo-sm">
                ...
                <span class="logo-lg-text-light">Transferano</span>
            </span>
            <span class="logo-lg">
                <!-- <img src="~/assets/images/logo-dark.png" alt height="20" /> -->
                <span class="logo-lg-text-light">TR</span>
            </span>
        </nuxt-link>
    ...
    <simplebar class="h-100" data-simplebar>
        ...
        <div class="user-box text-center">
            ...
            <div class="dropdown">
                <a href="javascript: void(0);" class="text-reset dropdown-toggle h5 mt-2 mb-1 d-block" data-toggle="dropdown">Benjamin Francis</a>
