...
<div class="navbar-custom">
    <div class="container-fluid">
        <ul class="list-unstyled topnav-menu float-right mb-0" style="width: 90%;">
            <li class="d-none d-lg-block">
                <form class="app-search" style="width: 500px;max-width: 500px;">
                    <div class="app-search-box">
                        <div class="input-group" style="position: relative">
                            <input type="search" class="form-control" :placeholder="$t('navbar.search.text')" id="top-search" />
                            <div class="input-group-append" style="border:solid 1px #000">
            ...
            <b-nav-item-dropdown right class="notification-list topbar-dropdown float-right" menu-class="profile-dropdown" toggle-class="p-0">
            ...
            <b-nav-item-dropdown right class="notification-list float-right" menu-class="dropdown-lg">
                <template slot="button-content" class="nav-link dropdown-toggle">
