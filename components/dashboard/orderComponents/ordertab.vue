    ...
    <div>
        <div v-if="!orderWiz">
            <a-row class="tw-m-2">
				...
				<a-radio-group default-value="1" button-style="" class="tw-mr-5 tw-float-right tw-rounded-md tw-border-none tw-font-bold">
                ...
                <!-- <a-col :span="6" :offset="12">
                    ...
                    <a-menu slot="overlay">
                        <a-menu-item class="tw-p-2">
                        <a 
                            >buy order</a
                        >
                        </a-menu-item>
                        <a-menu-item class="tw-p-2">
                        <a @click="orderWiz=true" rel="noopener noreferrer"
                            >sell order</a
                        >
                        </a-menu-item>
                    </a-menu>
